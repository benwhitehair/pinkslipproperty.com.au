...
const Header = ({ siteTitle }) => (
  <>
    <header>
      <div className="bg-grey-darkest w-full">
        <div className="flex items-center justify-between max-w-2xl mx-auto py-2 px-4 md:px-8 w-full">
          <a
            className="flex items-center leading-none mr-2 no-underline text-white hover:text-pink-light"
            href="tel:0404222244"
          >
            <svg
    ...
    <nav className="bg-white font-condensed pin-t py-4 md:py-0 shadow-md md:sticky text-lg">
